...
in `docs/roadmap.md` under "Vault token lifecycle" — not shipped in S6.
...
— rotating them invalidates outstanding tokens. See `docs/key-rotation.md`.
...
Tracked under "S26 — AWS KMS adapter" in `docs/roadmap.md`.
